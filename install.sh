...
sudo apt install -y libblas-dev libblas64-dev
# OpenCV Dependencies - LAPACK
sudo apt install -y liblapack-dev liblapack64-dev
# OpenCV Dependencies - LAPACKE
sudo apt install -y liblapacke-dev liblapacke64-dev
# OpenCV Dependencies - ATLAS
sudo apt install -y libatlas-base-dev libatlas-cpp-0.6-dev
# OpenCV Dependencies - OpenBLAS
sudo apt install -y libopenblas-dev libopenblas64-dev

# OpenCV Dependencies - GTK & VTK
sudo apt install -y libgtk-3-dev libvtk7-dev
# OpenCV Dependencies - Images
sudo apt install -y zlib1g-dev libjpeg-turbo8-dev libwebp-dev libpng-dev libtiff-dev libopenjp2-7-dev libopenexr-dev
# OpenCV Dependencies - Videos
sudo apt install -y libdc1394-dev libavcodec-dev libavformat-dev libavutil-dev libswscale-dev libavresample-dev libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev
...
# OGRE Dependencies
sudo apt install -y libgles2-mesa-dev libxt-dev libxaw7-dev libsdl2-dev libfreetype-dev libfreeimage-dev nvidia-cg-toolkit
# OGRE Build
cd ./ogre
